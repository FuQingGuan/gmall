...
![](https://oss.yiki.tech/gmall/202303122327167.png)
...
![](https://oss.yiki.tech/gmall/202303122327586.png)

![](https://oss.yiki.tech/gmall/202303122327053.png)

### 新增用户

![](https://oss.yiki.tech/gmall/202303122327937.png)

### 新增 Virtual Hosts

![](https://oss.yiki.tech/gmall/202303122327503.png)

### 新增权限

![](https://oss.yiki.tech/gmall/202303122327459.png)

![](https://oss.yiki.tech/gmall/202303122327289.png)

### 切换用户

![](https://oss.yiki.tech/gmall/202303122327901.png)
...
<div>
  ...
  <video id="video" controls="" width="800" height="500" preload="none" poster="封面">
        <source id="mp4" src="https://oss.yiki.tech/gmall/202303122328298.mp4" type="video/mp4">
  </videos>
</div>


![](https://oss.yiki.tech/gmall/202303122328977.png)
...
![](https://oss.yiki.tech/gmall/202303122328373.png)

![](https://oss.yiki.tech/gmall/202303122329971.png)

![](https://oss.yiki.tech/gmall/202303122329517.png)

![](https://oss.yiki.tech/gmall/202303122329382.png)

![](https://oss.yiki.tech/gmall/202303122329430.png)

![](https://oss.yiki.tech/gmall/202303122329196.png)
...
<div>
  <!-- mp4格式 -->
  <video id="video" controls="" width="800" height="500" preload="none" poster="封面">
        <source id="mp4" src="https://oss.yiki.tech/gmall/202303122329702.mp4" type="video/mp4">
  </videos>
</div>


![](https://oss.yiki.tech/gmall/202303122329820.png)

![](https://oss.yiki.tech/gmall/202303122330598.png)

> 配置能者多劳后, 可以发现能力较弱的服务A只消费了一条消息, 而能力强的服务B则将剩下的全部消息消费完毕.
> (去掉消费者端 睡眠方法, 配置文件中添加 能者多劳配置. 重启两台服务, 在消费者端添加睡眠代码. 任意重启一台服务 发送消息即可看到前后差异)

![](https://oss.yiki.tech/gmall/202303122330899.png)

![](https://oss.yiki.tech/gmall/202303122330217.png)
...
![](https://oss.yiki.tech/gmall/202303122330060.png)

![](https://oss.yiki.tech/gmall/202303122330077.png)

<div>
  <!-- mp4格式 -->
  <video id="video" controls="" width="800" height="500" preload="none" poster="封面">
        <source id="mp4" src="https://oss.yiki.tech/gmall/202303122330903.mp4" type="video/mp4">
  </videos>
</div>
...
![](https://oss.yiki.tech/gmall/202303122331919.png)

![](https://oss.yiki.tech/gmall/202303122331584.png)

![](https://oss.yiki.tech/gmall/202303122331225.png)
...
<div>
  <!-- mp4格式 -->
  <video id="video" controls="" width="800" height="500" preload="none" poster="封面">
        <source id="mp4" src="https://oss.yiki.tech/gmall/202303122331283.mp4" type="video/mp4">
  </videos>
</div>
...
![](https://oss.yiki.tech/gmall/202303122332605.png)

* 概念
  * 死信队列、死信交换机
    * 本质都是普通的队列和交换机, 只是存储转发的是死信消息

![](https://oss.yiki.tech/gmall/202303122332399.png)
...
<div>
  <!-- mp4格式 -->
  <video id="video" controls="" width="800" height="500" preload="none" poster="封面">
        <source id="mp4" src="https://oss.yiki.tech/gmall/202303122333756.mp4" type="video/mp4">
  </videos>
</div>
...
<div>
  <!-- mp4格式 -->
  <video id="video" controls="" width="800" height="500" preload="none" poster="封面">
        <source id="mp4" src="https://oss.yiki.tech/gmall/202303122334181.mp4" type="video/mp4">
  </videos>
</div>
